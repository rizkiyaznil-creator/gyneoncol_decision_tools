export default {
  ...
  references: [
    ...
    'Reed NS, dkk. Phase III randomised study to evaluate the role of adjuvant pelvic radiotherapy in the treatment of uterine sarcomas stages I and II: an EORTC-GCG study (55874). Eur J Cancer. 2008;44(6):808-818.',
    'Hensley ML, dkk. Adjuvant gemcitabine plus docetaxel followed by doxorubicin versus observation for high-grade uterine leiomyosarcoma: a phase III GOG study (GOG-277).',
    'Powell MA, dkk. Carboplatin and paclitaxel versus ifosfamide and paclitaxel for uterine carcinosarcoma (GOG-261). J Clin Oncol. 2022;40(9):968-977.',
